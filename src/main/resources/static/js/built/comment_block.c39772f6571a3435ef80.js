...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main/resources/static/js/react/comment_block.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/css-loader/index.js!./src/main/resources/static/js/react/wall.css":
/*!*******************************************************************************!*\
  !*** ./node_modules/css-loader!./src/main/resources/static/js/react/wall.css ***!
  \*******************************************************************************/
...
// module
exports.push([module.i, "body,h2{font-family:arial;color:#333;background-color:#f2f2f2}a{color:#365899;text-decoration:none}a:hover{color:#365899;text-decoration:underline}#container{background-color:#fff;width:800px}#wallContainer{padding:20px;border:solid 1px #efefef;margin:10px 0}#wallPost{padding:10px 15px;font-weight:700;border:1px solid #365899;border-radius:4px;color:#fff;float:right;background-color:#365899}#updateBox,.commentInput{border:solid 1px #999}#wallFeed{clear:both;padding-top:10px}textarea{display:block;background-color:solid 1px #dedede;width:100%;border-radius:4px;margin-bottom:10px;height:50px}.feedCommentForm,.feedCommentGrid{margin-left:85px;clear:both;padding:10px 5px;border-top:solid 1px #dedede;width:350px;background:#f2f2f2}.feedBody{min-height:75px;margin-bottom:10px;border-bottom:solid 1px #efefef;padding:10px 0;clear:both}.feedImg{float:left;height:60px;width:60px;padding:5px}.feedText{margin-left:75px;word-wrap:break-word;//Textjustificationoverflow:hidden;padding:5px;display:block;word-wrap:break-word}.feedText b{display:block;line-height:30px}.feedLinks{margin-left:75px;padding:5px;font-size:12px}.feedDelete{float:right;margin-right:10px;font-weight:700;padding:4px}.commentImg{width:32px;height:32px;float:left}.commentText{margin-left:42px;font-size:13px;width:300px;word-wrap:break-word}.commentText b{line-height:20px!important}.commentInput{width:344px;height:40px}.commetDelete{float:right}.commetDelete,.feedDelete,.commentLink,b{text-decoration:none;color:#365899}.commentSubmit{background:#365899;border:solid 1px #365899;padding:4px 6px;color:#fff;border-radius:4px}#block{position:absolute;width:350px;height:600px;margin-top:150px}", ""]);
...
/***/ "./src/main/resources/static/js/react/comment_block.js":
/*!*************************************************************!*\
  !*** ./src/main/resources/static/js/react/comment_block.js ***!
  \*************************************************************/
/*! no exports provided */
...
/* harmony import */ var _wall_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wall.css */ "./src/main/resources/static/js/react/wall.css");
/* harmony import */ var _wall_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wall_css__WEBPACK_IMPORTED_MODULE_2__);
...
function (_React$Component) {
  _inherits(WallContainer, _React$Component);

  function WallContainer() {
    _classCallCheck(this, WallContainer);

    return _possibleConstructorReturn(this, _getPrototypeOf(WallContainer).apply(this, arguments));
  }
  ...
  _createClass(WallContainer, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "wallContainer"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Social Network System with React JS Demo"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WallFeed, null));
    }
  }]);
...
function (_React$Component2) {
  _inherits(WallFeed, _React$Component2);

  function WallFeed(props) {
    var _this;

    _classCallCheck(this, WallFeed);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(WallFeed).call(this, props));
    _this.state = {
      data: []
    };
    _this.updateAjaxSubmit = _this.updateAjaxSubmit.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.deleteUpdate = _this.deleteUpdate.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(WallFeed, [{
    key: "updateAjaxSubmit",
    value: function updateAjaxSubmit(update) {
      var _this2 = this;

      ajaxPostReact("/api/updates", update, function (data) {
        var updates = _this2.state.data;
    ...
    key: "updatesFromServer",
    value: function updatesFromServer() {
      var _this3 = this;

      var dataPost = {};
      ajaxPostReact("/api/comments", dataPost, function (data) {
        _this3.setState({
          data: data.updates
        });
      });
    ...
    value: function deleteUpdate(e) {
      ...
      ajaxPostReact("/api/deleteUpate", data, function () {
        _this4.state.data.splice(updateIndex, 1);
    ...
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WallForm, {
        onUpdateSubmit: this.updateAjaxSubmit
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WallUpdates, {
...
function (_React$Component3) {
  _inherits(WallForm, _React$Component3);

  function WallForm(props) {
    var _this5;

    _classCallCheck(this, WallForm);

    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(WallForm).call(this, props));
    _this5.state = {
      user_update: ''
    };
    _this5.updateChange = _this5.updateChange.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.updateSubmit = _this5.updateSubmit.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    return _this5;
  }

  _createClass(WallForm, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.findDOMNode(this.refs.updateInput).focus();
    }
  }, {
    key: "updateChange",
    value: function updateChange(e) {
      this.setState({
        user_update: e.target.value
      });
    }
  }, {
    key: "updateSubmit",
...
function (_React$Component4) {
  _inherits(WallUpdates, _React$Component4);

  function WallUpdates() {
    _classCallCheck(this, WallUpdates);

    return _possibleConstructorReturn(this, _getPrototypeOf(WallUpdates).apply(this, arguments));
  }

  _createClass(WallUpdates, [{
    key: "render",
    value: function render() {
      var _this6 = this;

      var updateEach = this.props.data.map(function (update, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "feedBody",
          key: update.created
          ...
          className: "feedText"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, update.name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "#",
          className: "feedDelete",
          value: index,
          data: update.update_id,
          onClick: _this6.props.deleteUpdate
        }, "X"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          dangerouslySetInnerHTML: {
            __html: textToLink(update.user_update)
          }
        })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CommentBlock, {
          dataComments: update.comments,
...
function (_React$Component5) {
  _inherits(CommentBlock, _React$Component5);
  ...
  function CommentBlock(props) {
    ...
    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(CommentBlock).call(this, props));
    _this7.state = {
      showComment: false
    };
    return _this7;
  ...
  _createClass(CommentBlock, [{
    ...
    value: function renderCommentForm() {
      if (this.state.showComment) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CommentForm, null);
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        onClick: function onClick() {
          _this8.setState({
            showComment: !_this8.state.showComment
          });
        }
      }, "Comment")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CommentGrid, {
...
function (_React$Component6) {
  _inherits(CommentGrid, _React$Component6);

  function CommentGrid() {
    _classCallCheck(this, CommentGrid);

    return _possibleConstructorReturn(this, _getPrototypeOf(CommentGrid).apply(this, arguments));
  }

  _createClass(CommentGrid, [{
    key: "render",
    value: function render() {
      var comments = this.props.dataComments.map(function (comment, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "feedCommentGrid",
          key: comment.com_id
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
        ...
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, comment.name), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          href: "#",
          data: comment.com_id,
          value: index,
          className: "commentDelete"
        }, "X"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          dangerouslySetInnerHTML: {
            __html: textToLink(comment.comment)
          }
        }))));
      });
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
function (_React$Component7) {
  ...
  function CommentForm() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CommentForm).apply(this, arguments));
  }
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WallContainer, null), document.getElementById('container'));

/***/ }),

/***/ "./src/main/resources/static/js/react/wall.css":
/*!*****************************************************!*\
  !*** ./src/main/resources/static/js/react/wall.css ***!
  \*****************************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader!./wall.css */ "./node_modules/css-loader/index.js!./src/main/resources/static/js/react/wall.css");
...
/******/ });
//# sourceMappingURL=comment_block.c39772f6571a3435ef80.js.map